...
class LogoController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect()->route('logos.view')->with('success','Data Added successfull');
    }
    ...
    public function update(Request $request,$id){
        ...
        return redirect()->route('logos.view')->with('success','Data Updated successfull');
    }
    public function delete($id){
        ...
        $logo -> delete();
         return redirect()->route('logos.view')->with('success','Data Delete successfull');
    }
}
