...
class SliderController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect()->route('sliders.view')->with('success','Data Added successfull');
    }
    ...
    public function update(Request $request,$id){
        ...
        return redirect()->route('sliders.view')->with('success','Data Updated successfull');
    }
    public function delete($id){
        ...
        $slider -> delete();
         return redirect()->route('sliders.view')->with('success','Data Delete successfull');
    }
}
