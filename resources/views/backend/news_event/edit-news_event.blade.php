                            ...
                            <form method="post" action="{{route('news_events.update',$editData->id)}}" id="myForm" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                     ...
                                     <input type="text" name="date" class="form-control" placeholder="YYYY-MM-DD" id="datepicker" value="{{$editData->date}}" readonly >
                                   ...
                                   <div class="form-group col-md-8">
                                    ...
                                    <div class="form-group col-md-12">
                                     ...
                                     <textarea  name="long_title" class="form-control" rows="5">value="{{$editData->long_title}}"</textarea>
                                    ...
                                    <div class="form-group col-md-2">
                                     <img id="showImage"  src="{{(!empty($editData->image))?url('public/upload/news_images/'.$editData->image):url('public/upload/no_imgae .png')}}" style="width:150px; height: 160px; border:1px solid #000;" >
                                    </div>
